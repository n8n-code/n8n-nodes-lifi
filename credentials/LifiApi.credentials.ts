...
export class LifiApi implements ICredentialType {
	name = 'N8nDevLifiApi';

	displayName = 'lifi API';

	icon: Icon = { light: 'file:../nodes/Lifi/lifi.svg', dark: 'file:../nodes/Lifi/lifi.dark.svg' };
	...
	properties: INodeProperties[] = [
		{
			...
			required: true,
			placeholder: 'https://li.quest',
			description: 'The base URL of your lifi API server',
		},
		{
			displayName: 'API Key',
			name: 'apiKey',
